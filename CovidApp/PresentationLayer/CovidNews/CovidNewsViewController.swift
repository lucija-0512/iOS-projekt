...
class CovidNewsViewController: UIViewController {
    ...
    init(presenter: CovidNewsDataPresenter) {
...
extension CovidNewsViewController: UITableViewDataSource {
...
extension CovidNewsViewController: UITableViewDelegate {
...
extension CovidNewsViewController: UISearchResultsUpdating {
